...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>   
<%@page import="com.concentrate.search.codegen.*,com.concentrate.search.hotswap.bean.*,java.util.*" %>
<%
		...
		<form action="queryAlgorithm.jsp">
			...
			<div class="searchItem">
				...
				if(scopeType == Constant.SCOPE_TYPE_FOR_SEARCH_PAGE) {
					...
					"<span>销售额得分：<input type=\"text\"  class=\"param\" name=\"listSalesAmountScore\" value=\""+param.listSalesAmountScore+"\"/></p>"+
					"<span>好评率得分：<input type=\"text\"  class=\"param\" name=\"listPraiseScore\" value=\""+param.listPraiseScore+"\"/></p>");
				}
