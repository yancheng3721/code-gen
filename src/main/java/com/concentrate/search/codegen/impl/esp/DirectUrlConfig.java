...
public class DirectUrlConfig implements ModuleConfig {
	...
	public LinkedHashMap<String, Map<String, String>> getAllFileds() {
		...
		results.put("KEYWORD",
				CodeGenerator.newFiled("KEYWORD", "关键词", "NOT_NULL"));
		results.put("URL", CodeGenerator.newFiled("URL", "直达URL", "NOT_NULL"));
		results.put("START_TIME",
				CodeGenerator.newFiled("START_TIME", "生效时间", "NOT_NULL","TIME"));
